...
// ../../node_modules/.pnpm/@babylonjs+core@7.54.3/node_modules/@babylonjs/core/Misc/dumpTools.js
...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-YJRPBI7M.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-QBWIFUOQ.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-ZXPLY3VZ.js.map
