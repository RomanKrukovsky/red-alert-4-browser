...
export interface RuntimeAssetDefinition {
  ...
  sockets?: { muzzle?: string; turretYaw?: string; gunPitch?: string; selection?: string; healthBar?: string };
...
export const runtimeAssetManifest: RuntimeAssetDefinition[] = [
  ...
  { id: 'SU_BogatyrOreCarrier', url: '/assets/models/units/SU_BogatyrOreCarrier_LOD0.glb', category: 'unit', rootNode: 'VehicleRoot', lods: [{ url: '/assets/models/units/SU_BogatyrOreCarrier_LOD1.glb', distance: 28 }, { url: '/assets/models/units/SU_BogatyrOreCarrier_LOD2.glb', distance: 48 }], sockets: { selection: 'SelectionAnchor', healthBar: 'HealthBarAnchor' }, collision: { type: 'mesh', node: 'CollisionRoot' }, castShadows: true, receiveShadows: true, instancing: 'instance' },
  ...
  { id: 'SU_HeavyFactory', url: '/assets/models/buildings/SU_HeavyFactory_LOD0.glb', category: 'building', rootNode: 'BuildingRoot', lods: [{ url: '/assets/models/buildings/SU_HeavyFactory_LOD1.glb', distance: 38 }, { url: '/assets/models/buildings/SU_HeavyFactory_LOD2.glb', distance: 62 }], sockets: { selection: 'SelectionAnchor', healthBar: 'HealthBarAnchor' }, collision: { type: 'mesh', node: 'CollisionRoot' }, castShadows: true, receiveShadows: true, instancing: 'instance' },
