...
// The simulation roster is larger than the first visual slice. These entries
// keep every unit and buildable structure on the battlefield on a real model.
const additionalGameplayAssets: RuntimeAssetDefinition[] = [
  ...[
    'SU_ZaslonAATeam', 'SU_MasterEngineer', 'SU_RysScout', 'SU_ZarevoMLRS', 'SU_BuranPatrolBoat',
    'AL_LancerTeam', 'AL_FieldEngineer', 'AL_KestrelScout', 'AL_OracleArtillery', 'AL_MantaPatrolCraft',
    'CO_VajraLancer', 'CO_JieTechnician', 'CO_KamakiriWalker', 'CO_MonsoonArtillery', 'CO_KazekiriCorvette',
    'CH_PunctureLancer', 'CH_CausalityEngineer', 'CH_ParallaxScout', 'CH_DeltaDelayArtillery', 'CH_IsobathFrigate',
