...
export type ServerMessage =
  | ServerMessageLobbyState
  | ServerMessageMatchStart
  | ServerMessageTickFrame
  | ServerMessageSnapshot
  | ServerMessageChecksumMismatch
  | ServerMessageGameOver
  | ServerMessageError;
...
export type ClientMessage =
  ...
  | ClientMessageSetSlot
  | ClientMessageSetMap
  | ClientMessageSetReady
  | ClientMessageStartMatch
  | ClientMessageSubmitCommand
  | ClientMessageChecksumReport
