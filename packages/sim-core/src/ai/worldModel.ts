...
export class AIWorldModel {
  public update(sim: GameSimulation, bb: AIBlackboard): void {
  ...
  public getKnownEnemyTargets(bb: AIBlackboard): IntelMemoryEntry[] {
    return Array.from(bb.intelEntries.values()).filter(e => e.certainty > 0.1);
  }

  public getKnownEnemyHQ(bb: AIBlackboard): IntelMemoryEntry | null {
