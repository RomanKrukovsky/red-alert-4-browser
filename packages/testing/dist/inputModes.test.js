...
async function runTests() {
    ...
    const helpResult = await adminService.executeCommand('help');
    ...
    const spawnResult = await adminService.executeCommand('spawn SU_GranitMBT 30 30');
    ...
    const teleportResult = await adminService.executeCommand('teleport 50 50');
...
void runTests();
//# sourceMappingURL=inputModes.test.js.map