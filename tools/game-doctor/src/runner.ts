...
import { GameDoctorOptions, GameDoctorReport, PerformanceSnapshot } from './types.js';
...
export class GameDoctorRunner {
  private options: GameDoctorOptions;
